...
class ESIM(nn.Module):
    ...
    def __init__(self,bert_path='model/chinese-roberta-wwm-ext/',
                    in_size = 768,
                    hidden_size = 300,
                    out_size = 2 ,
                    dropout = 0.5
    ...
    def forward(self,
        ...
        embedded_premises = self.embedding(premises,premise_seg_ids,premise_mask)
        embedded_premises = embedded_premises.last_hidden_state
        # print(embedded_premises)
        # print(type(embedded_premises))
        # print(embedded_premises)
        embedded_hypotheses = self.embedding(hypotheses,hypo_seg_ids,hypotheses_mask)
        embedded_hypotheses = embedded_hypotheses.last_hidden_state
        # print(type(embedded_premises))
...
if __name__=='__main__':
    tokenizer = AutoTokenizer.from_pretrained('model/chinese-roberta-wwm-ext/')
    a = tokenizer(['我喜欢北京'])
